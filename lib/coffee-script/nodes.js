...
(function() {
  var Access, Arr, Assign, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, MonadSoak, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.MonadSoak = MonadSoak = (function(_super) {
    __extends(MonadSoak, _super);

    function MonadSoak(base, child) {
      this.base = base;
      this.child = child;
    }

    MonadSoak.prototype.nodeToString = function(node) {
    ...
    MonadSoak.prototype.compileNode = function() {
      var baseCode, baseRef, baseReffage, childCode, funcRef, wrappedCode;
      ...
      return [new CodeFragment(this, "(" + baseReffage + ", " + baseRef + ").and_then(function(" + funcRef + "){return " + wrappedCode + ";})")];
    };

...
(function() {
  ...
  exports.MonadSoak = MonadSoak = (function(_super) {
    ...
    MonadSoak.prototype.compileNode = function() {
      var base_code, child_code, code, _i, _j, _len, _len1, _ref2, _ref3;
      base_code = "";
      _ref2 = this.base.compileNode();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        code = _ref2[_i];
        base_code += code.code;
      }
      child_code = "";
      _ref3 = this.child.compileNode();
      for (_j = 0, _len1 = _ref3.length; _j < _len1; _j++) {
        code = _ref3[_j];
        child_code += code.code;
      }
      return [new CodeFragment(this, "(" + base_code + ").and_then(function(x){return x." + child_code + ";)")];
    };

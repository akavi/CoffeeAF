...
(function() {
  var Access, Arr, Assign, BackCall, Base, Block, Call, Class, Code, CodeFragment, Comment, Existence, Expansion, Extends, For, HEXNUM, IDENTIFIER, IDENTIFIER_STR, IS_REGEX, IS_STRING, If, In, Index, LEVEL_ACCESS, LEVEL_COND, LEVEL_LIST, LEVEL_OP, LEVEL_PAREN, LEVEL_TOP, Literal, METHOD_DEF, MonadCall, NEGATE, NO, NUMBER, Obj, Op, Param, Parens, RESERVED, Range, Return, SIMPLENUM, STRICT_PROSCRIBED, Scope, Slice, Splat, Switch, TAB, THIS, Throw, Try, UTILITIES, Value, While, YES, addLocationDataFn, compact, del, ends, extend, flatten, fragmentsToText, isLiteralArguments, isLiteralThis, last, locationDataToString, merge, multident, parseNum, some, starts, throwSyntaxError, unfoldSoak, utility, _ref, _ref1,
  ...
  exports.Block = Block = (function(_super) {
    ...
    Block.prototype.compileNode = function(o) {
      var answer, backCallFragment, compiledNodes, fragments, index, node, top, _i, _len, _ref2;
      this.tab = o.indent;
      ...
      for (index = _i = 0, _len = _ref2.length; _i < _len; index = ++_i) {
        ...
        if (node instanceof Block) {
          ...
          node.giveBlock(Block.wrap(this.expressions.slice(index + 1)));
          backCallFragment = node.compileNode(o);
          backCallFragment.unshift(this.makeCode("" + this.tab));
  ...
  exports.MonadCall = MonadCall = (function(_super) {
    __extends(MonadCall, _super);

    function MonadCall(base, child) {
      this.base = base;
      this.child = child;
    }

    MonadCall.prototype.nodeToString = function(node) {
      var code, fragment, _i, _len, _ref2;
      code = "";
      _ref2 = node.compileNode();
      for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
        fragment = _ref2[_i];
        code += fragment.code;
      }
    ...
    MonadCall.prototype.compileNode = function() {
      var baseCode, baseRef, baseReffage, childCode, funcRef, wrappedCall;
      baseCode = this.nodeToString(this.base);
      childCode = this.nodeToString(this.child);
      funcRef = "_ref1";
      baseRef = "_ref2";
      baseReffage = "" + baseRef + " = " + baseCode;
      wrappedCall = "new (" + baseRef + ").constructor(" + funcRef + "." + childCode + ")";
      return [new CodeFragment(this, "(" + baseReffage + ", " + baseRef + ").and_then(function(" + funcRef + "){return " + wrappedCall + ";})")];
    };
  ...
  exports.BackCall = BackCall = (function(_super) {
    ...
    function BackCall(assign, call) {
      this.assign = assign;
      this.call = call;
    }

    BackCall.prototype.giveBlock = function(block) {
      var callVar;
      callVar = new Param(this.assign);
      return this["function"] = new Code([callVar], block, 'boundfunc');
    };

    BackCall.prototype.compileNode = function(o) {
      this.call.tab = o.indent;
      this.call.args.push(this["function"]);

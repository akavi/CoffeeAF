...
(function() {
  ...
  grammar = {
    ...
    Line: [
      o('Identifier =< Invocation', function() {
        return new BackCall($1, $3);
      }), o('Expression'), o('Statement')
    ],
    Statement: [
    ...
    Invocation: [
      o('SimpleInvocation', function() {
        return $1;
      }), o('MonadInvocation', function() {
        return $1;
      })
    ],
    MonadInvocation: [
      o('Value &. Identifier', function() {
        return new MonadCall($1, $3);
      }), o('Value &. Identifier OptFuncExist Arguments', function() {
        return new MonadCall($1, new Call($3, $5, $4));
      }), o('Invocation &. Identifier', function() {
        return new MonadCall($1, $3);
      }), o('Invocation &. Identifier OptFuncExist Arguments', function() {
        return new MonadCall($1, new Call($3, $5, $4));
      })
    ],
    SimpleInvocation: [
      ...
      }), o('SimpleInvocation OptFuncExist Arguments', function() {
        return new Call($1, $3, $2);
      }), o('SUPER', function() {

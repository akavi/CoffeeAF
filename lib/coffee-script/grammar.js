...
(function() {
  ...
  grammar = {
    ...
    Expression: [o('MonadSoak'), o('Value'), o('Invocation'), o('Code'), o('Operation'), o('Assign'), o('If'), o('Try'), o('While'), o('For'), o('Switch'), o('Class'), o('Throw')],
    MonadSoak: [
      o('Value &. Invocation', function() {
        return new MonadSoak($1, $3);
      }), o('MonadSoak &. Invocation', function() {
        return new MonadSoak($1, $3);
      }), o('Value &. Identifier', function() {
        return new MonadSoak($1, $3);
      }), o('MonadSoak &. Identifier', function() {
        return new MonadSoak($1, $3);
      })
    ],
    Block: [
